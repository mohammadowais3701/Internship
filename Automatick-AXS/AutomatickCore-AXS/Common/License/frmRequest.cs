...
namespace LicenseAPI
{
    public partial class frmRequest : Form
    {
        ...
        String AppPreFix = "";
        public frmRequest(String appPreFix, String ProccessorID, String HarddiskSerial, String ApplicationPrefix, XmlDocument xmlServiceURL, String filePath)
        {
        ...
        private void btnRequest_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                LicenseCore lic = new LicenseCore(AppPreFix, _filePath, false);
