    ...
    public class HtmlNode : IXPathNavigable
    {
        ...
        public virtual string InnerHtml
        {
            get
            {
                ...
                if (!String.IsNullOrEmpty(_ownerdocument.OriginalText))
                {
                    returnString = _ownerdocument.OriginalText.Substring(_innerstartindex, _innerlength);
                }
        ...
        public string Name
        {
            get
            {
                if (_name == null)
                {
                    Name = _ownerdocument.OriginalText.Substring(_namestartindex, _namelength);
                }
        ...
        public virtual string OuterHtml
        {
            get
            {
                ...
                return _ownerdocument.OriginalText.Substring(_outerstartindex, _outerlength);
            }
        }
