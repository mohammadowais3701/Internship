    ...
    class Program
    {
        ...
        static void Main(string[] args)
        {
           /* string address = "http://localhost:8733/WcfServiceLibrary1";
            ...
            EndpointAddress endpointAddress = new EndpointAddress("http://10.0.35.170:8735/WCF_BASICHTTP/Service1/");
            
            channelFactory = new ChannelFactory<IService1>(basicBinding, endpointAddress);
